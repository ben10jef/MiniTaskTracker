...
export default function AddTask({title, setTitle, desc, setDesc, category, setCategory, onAdd}) {
    ...
    return (
        <div className="card pad">
            ...
            <label htmlFor="task-title" className="row-desc" style={{display: 'block', marginBottom: 4}}>Task title
                *</label>
            <input
                id="task-title"
                ref={inputRef}
            ...
            <label htmlFor="task-desc" className="row-desc" style={{display: 'block', marginTop: 12, marginBottom: 4}}>Description
                (optional)</label>
            <textarea
                id="task-desc"
                value={desc}
            ...
            <label htmlFor="task-cat" className="row-desc"
                   style={{display: 'block', marginTop: 12, marginBottom: 4}}>Category</label>
            <select
                id="task-cat"
                value={category}
